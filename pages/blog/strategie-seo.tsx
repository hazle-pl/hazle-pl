      ...
      <Layout>
        <article>
          ...
          <Container paddingBottom='3' paddingTop='3'>
            <TeaserCard imagePosition="left" imageSrc='https://designerup.co/blog/content/images/2023/07/2.png' content={`<h2>1. Zrozumienie podstaw SEO</h2>
          ...
          <Container paddingBottom='3' paddingTop='3'>
            <TeaserCard imagePosition="right" imageSrc='https://designerup.co/blog/content/images/2023/07/3.png' content={`<h2>2. Analiza konkurencji i dobór słów kluczowych</h2>
          ...
          <Container paddingBottom='3' paddingTop='3'>
            <TeaserCard imagePosition="left" imageSrc='https://designerup.co/blog/content/images/2023/07/4.png' content={`<h2>3. Optymalizacja treści i linki wewnętrzne</h2>
          ...
          <Container paddingBottom='3' paddingTop='3'>
            <TeaserCard imagePosition="right" imageSrc='https://designerup.co/blog/content/images/2023/07/5.png' content={`<h2>4. Budowanie linków zewnętrznych</h2>
          ...
          <Container paddingBottom='3' paddingTop='3'>
            <TeaserCard imagePosition="left" imageSrc='https://designerup.co/blog/content/images/2023/07/6.png' content={`<h2>5. Regularne monitorowanie wyników</h2>
